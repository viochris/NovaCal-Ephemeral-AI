...
TELEGRAM_TOKEN = os.getenv("TELEGRAM_TOKEN_Nova_cal_ephemeral")
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try: 
        ...
        prompt = ChatPromptTemplate.from_messages([
            ...
            7. AUTO-DESTRUCT SIGNAL: If you SUCCESSFULLY use a tool to create, update, or delete an event, you MUST include the exact string "[TASK_DONE]" at the very end of your final response to the user.
